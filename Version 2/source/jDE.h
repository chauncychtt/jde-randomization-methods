...
public:
   ...
   */
  void runDE(uint, uint, const vDouble &, vDouble &, const double, const double, uint);
  ...
  */
  ...
  double remap(double from, double fromMin, double fromMax, double toMin,  double toMax);
};
